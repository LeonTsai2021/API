...
namespace _20220704_Practice.Helper
{
    public class JwtHelpers
    {
        private readonly IConfiguration Configuration;//表示配置集合的接口，一般的，程序通过从DI获取IConfiguration接口的实例来获取配置

        public JwtHelpers(IConfiguration configuration)
        {
            this.Configuration = configuration;
        }
        public string GenerateToken(string userName, int expireMinutes = 30)//設定驗證過期時間為30分鐘
        {
